import sys
sys.path.append('/home/masa/Downloads/shit/dev/Langchain-Chatchat')
import os
import shutil
...
class FaissRagKBService(KBService):
    vs_path: str
    kb_path: str
...
if __name__ == '__main__':
    faissService = FaissRagKBService("test")
    faissService.add_doc(KnowledgeFile("knowledge2.txt", "test"))
